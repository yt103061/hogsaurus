  ...
  "exercises": [
    {
      ...
      "tip": "意識するポイント（30文字以内）",
      "poseKey": "アニメーション識別子（下記から1つ選択）"
    }
  ],
  "afterMessage": "終わった後への一言（30文字以内）"
}

poseKeyの選択肢（種目の動きに最も近いものを選ぶ）:
- "neck-side"      : 首を横に倒す・首の横ストレッチ
- "neck-rotation"  : 首を回す・頸椎の回旋
- "shoulder-open"  : 肩甲骨寄せ・胸を開く・肩を後ろに引く
- "spine-twist"    : 腰ひねり・体幹の回旋・ツイスト系
- "forward-bend"   : 前屈・体を前に倒す
- "overhead"       : 腕を上げる・万歳・上肢を頭上へ
- "idle"           : 呼吸法・眼球運動・その場で動かない系
